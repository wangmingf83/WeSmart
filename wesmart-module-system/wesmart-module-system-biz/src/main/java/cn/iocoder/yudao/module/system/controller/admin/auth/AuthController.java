...
import cn.iocoder.yudao.module.system.active_sso_client.ActiveSsoClientHandler;
...
public class AuthController {
    ...
    @Resource
    private ActiveSsoClientHandler activeClientHandler;

    @PostMapping("/login")
    @PermitAll
    @Operation(summary = "使用账号密码登录")
    public CommonResult<AuthLoginRespVO> login(@RequestBody @Valid AuthLoginReqVO reqVO, HttpServletResponse response) {
        AuthLoginRespVO authResp = authService.login(reqVO);
//        activeClientHandler.ragAgent(authResp, response);
        return success(authResp);
    }
