...
public interface IWeMomentsUserService extends IService<WeMomentsUser> {
     ...
     */
    void addMomentsUser(Long momentsTaskId, List<AdminUserAllDTO> users);
     ...
     */
    List<AdminUserAllDTO> getMomentsTaskExecuteUser(Integer scopeType, List<Long> deptIds, List<String> postIds, List<String> weUserIds);
     ...
     */
    void syncAddMomentsUser(Long momentsTaskId, MomentsListDetailResultDto.Moment moment, AdminUserAllDTO sysUser);
