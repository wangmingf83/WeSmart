...
import cn.iocoder.yudao.module.smart.dal.dataobject.product.analyze.vo.WeProductAnalyzeStatisticsVo;
import cn.iocoder.yudao.module.smart.dal.dataobject.product.analyze.vo.WeProductOrderDataReportVo;
import cn.iocoder.yudao.module.smart.dal.dataobject.product.analyze.vo.WeProductOrderTop5Vo;
...
public class WeProductAnalyzeController extends BaseController {
    ...
    @Operation(summary = "商品分析统计", method = "GET")
    ...
    @Operation(summary = "商品分析折线图", method = "POST")
    ...
    @Operation(summary = "商品订单Top5", method = "POST")
    ...
    @Operation(summary = "员工订单Top5", method = "POST")
    ...
    @Operation(summary = "数据报表-分页", method = "GET")
    ...
    @Operation(summary = "数据报表导出", method = "POST")
