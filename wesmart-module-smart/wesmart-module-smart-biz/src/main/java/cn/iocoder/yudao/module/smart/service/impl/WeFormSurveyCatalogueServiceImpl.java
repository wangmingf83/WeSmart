...
import cn.iocoder.yudao.module.common.constant.SiteStatsConstants;
...
import cn.iocoder.yudao.module.smart.dal.mysql.mapper.WeFormSurveyAnswerMapper;
import cn.iocoder.yudao.module.smart.dal.mysql.mapper.WeFormSurveyCatalogueMapper;
                ...
                if(StringUtils.isNotEmpty(weFormSurveyCatalogue.getChannelsName())){
                    ListUtil.toList(weFormSurveyCatalogue.getChannelsName().split(",")).stream().forEach(k->{
                        ...
                        weMaterialNewVo.setMaterialUrl(
                                StringUtils.substringBeforeLast(GuituAiConfig.getH5Domain(), "/") + weFormSurveyCatalogue.getHtmlPath()
