...
import cn.iocoder.yudao.module.smart.service.IWeMomentsInteracteService;
...
import cn.iocoder.yudao.module.smart.dal.dataobject.moments.dto.MomentsInteracteParamDto;
import cn.iocoder.yudao.module.smart.dal.dataobject.moments.dto.MomentsInteracteResultDto;
...
//            wrapper.eq(WeMomentsInteracte::getMomentId, momentsId);
            ...
            for (WeMomentsUser weMomentsUser : list) {
                ...
                MomentsInteracteResultDto comments = qwMomentsService.getMomentComments(dto);
//                if (comments.getCode() == HttpStatus.SUCCESS) {
                if (comments != null && comments.getErrMsg() == "") {
                    MomentsInteracteResultDto data = comments;
...
//                if (comments.getCode() == HttpStatus.SUCCESS) {
    ...
    private void makeTags(List<String> addTags, String weUserId, String externalUserid) {
        ...
        if (CollectionUtil.isNotEmpty(enterpriseTags)) {
            ...
            //同步标签到企微
            qwCustomerService.makeCustomerLabel(query);
        }
    }
    ...
    private void addCustomerTrajectory(WeMomentsInteracte weMomentsInteracte) {
        //互动人员为客户
        if (Integer.valueOf(1).equals(weMomentsInteracte.getInteracteUserType())) {
            iWeCustomerTrajectoryService.createInteractionTrajectory(
                    ...
                    Integer.valueOf(1).equals(weMomentsInteracte.getInteracteType()) ? TrajectorySceneType.TRAJECTORY_TITLE_DZPYQ.getType() : TrajectorySceneType.TRAJECTORY_TITLE_PLPYQ.getType(),
                    null);
        }
    }
}
