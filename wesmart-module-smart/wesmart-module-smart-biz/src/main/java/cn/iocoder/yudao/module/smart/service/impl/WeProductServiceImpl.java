...
import cn.iocoder.yudao.module.wecom.service.IQwProductService;
...
import cn.iocoder.yudao.module.smart.dal.dataobject.wecom.query.product.QwProductListQuery;
import cn.iocoder.yudao.module.smart.dal.dataobject.wecom.query.product.QwProductQuery;
import cn.iocoder.yudao.module.smart.dal.dataobject.wecom.vo.WeResultVo;
import cn.iocoder.yudao.module.smart.dal.dataobject.wecom.vo.customer.product.QwAddProductVo;
import cn.iocoder.yudao.module.smart.dal.dataobject.wecom.vo.customer.product.QwProductListVo;

import cn.iocoder.yudao.module.smart.dal.mysql.mapper.WeProductMapper;
import cn.iocoder.yudao.module.smart.dal.mysql.mapper.WeProductOrderMapper;
...
public class WeProductServiceImpl extends ServiceImpl<WeProductMapper, WeProduct> implements IWeProductService {
    ...
    public void addProduct(WeAddProductQuery query) throws ServiceException {
        ...
        QwAddProductVo productResult = productService.addProduct(productQuery);
    ...
    public void updateProduct(Long id, WeAddProductQuery query) throws ServiceException {
        ...
        WeResultVo productResult = productService.updateProductAlbum(productQuery);
        if (Objects.isNull(productResult)) {
    ...
    private QwProductListVo getQwProductList(QwProductListQuery query) {
        QwProductListVo productList = productService.getProductAlbumList(query);
