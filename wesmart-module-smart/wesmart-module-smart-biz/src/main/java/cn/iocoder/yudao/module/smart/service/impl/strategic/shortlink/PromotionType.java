package cn.iocoder.yudao.module.smart.service.impl.strategic.shortlink;
...
import cn.iocoder.yudao.module.smart.dal.dataobject.shortlink.query.WeShortLinkPromotionAddQuery;
import cn.iocoder.yudao.module.smart.dal.dataobject.shortlink.query.WeShortLinkPromotionTaskEndQuery;
import cn.iocoder.yudao.module.smart.dal.dataobject.shortlink.query.WeShortLinkPromotionUpdateQuery;
...
public abstract class PromotionType {
    ...
    public WeMessageTemplate getPromotionUrl(Long promotionId, Long shortLinkId, Integer style, Long materialId) throws IOException {
        ...
        String shortLinkDomainName = GuituAiConfig.getShortLinkDomainName();
