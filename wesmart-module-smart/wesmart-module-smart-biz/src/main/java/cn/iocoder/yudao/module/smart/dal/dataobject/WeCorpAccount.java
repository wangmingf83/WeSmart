...
public class WeCorpAccount extends BaseEntity {
    ...
    @Schema(description = "微信小程序密钥")
    @TableField("mini_secret")
    private String miniSecret;

    @Schema(description = "微信小程序原始ID")
     ...
     * 商城小程序app_id
     */
    @Schema(description = "商城小程序app_id")
     ...
     * 商城小程序消息推送token（令牌）
     */
    @Schema(description = "商城小程序消息推送token（令牌）")
     ...
     * 商城小程序消息推送秘钥
     */
    @Schema(description = "商城小程序消息推送秘钥")
     ...
     * 商城小程序消息推送-服务器地址
     */
    @Schema(description = "商城小程序消息推送-服务器地址")
