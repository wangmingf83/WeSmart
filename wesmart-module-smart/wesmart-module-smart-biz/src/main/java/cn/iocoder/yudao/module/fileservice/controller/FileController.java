package cn.iocoder.yudao.module.fileservice.controller;
...
public class FileController {
    ...
    public AjaxResult<Map<String, Object>> getCosConfig() {
        ...
        String aesKey = GuituAiConfig.getFile().getAesKey();
        AES aes = SecureUtil.aes(aesKey.getBytes(StandardCharsets.UTF_8));

        CosConfig cos = GuituAiConfig.getFile().getCos();
        Map<String, String> result = new HashMap<>(5);
        result.put("fileObject", aes.encryptBase64(GuituAiConfig.getFile().getObject()));
