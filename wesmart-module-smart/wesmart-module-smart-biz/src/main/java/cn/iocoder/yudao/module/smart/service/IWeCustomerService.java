...
public interface IWeCustomerService extends IService<WeCustomer> {
     ...
     * @return
     */
    Map<String, AdminUserAllDTO> findCurrentTenantSysUser();
     ...
     * @return
     */
    AdminUserAllDTO findSysUserInfoByWeUserId(String weUserId);
     ...
     * @return
     */
//    ScrmSysUser findCurrentSysUserInfo(Long userId);
    LoginUser findCurrentSysUserInfo(Long userId);
     ...
     * @return
     */
    List<AdminUserAllDTO> findAllSysUser();
