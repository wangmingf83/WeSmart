package cn.iocoder.yudao.module.scrm.framework.permission.core.aop;
...
import cn.iocoder.yudao.module.scrm.dal.dataobject.permission.CrmPermissionDO;
...
import static cn.iocoder.yudao.module.scrm.enums.ErrorCodeConstants.CRM_PERMISSION_DENIED;
...
@Aspect
@Slf4j
public class SCrmPermissionAspect {

    @Resource
    private SCrmPermissionService crmPermissionService;
