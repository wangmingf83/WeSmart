package cn.iocoder.yudao.module.smart.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode KF_ANSWER_NOT_EXISTS = new ErrorCode(2_020_013_001, "客服问答信息不存在");
    ErrorCode KF_INFO_NOT_EXISTS = new ErrorCode(2_020_013_002, "客服信息不存在");
    ErrorCode KF_ANSWER_ATTACHMENTS_NOT_EXISTS = new ErrorCode(2_020_013_003, "客服问答回答不存在");
    ErrorCode KF_ANSWER_GROUP_NOT_EXISTS = new ErrorCode(2_020_013_004, "客服问答分组不存在");
    ErrorCode KF_ANSWER_LIKE_QUESTION_NOT_EXISTS = new ErrorCode(2_020_013_005, "客服问答相似问题不存在");
    ErrorCode KF_CUSTOMER_NOT_EXISTS = new ErrorCode(2_020_013_006, "客服客户不存在");
    ErrorCode KF_CUSTOMER_STAT_NOT_EXISTS = new ErrorCode(2_020_013_007, "客服客户统计不存在");
    ErrorCode KF_EVENT_MSG_NOT_EXISTS = new ErrorCode(2_020_013_008, "客服事件消息不存在");
    ErrorCode KF_MSG_NOT_EXISTS = new ErrorCode(2_020_013_009, "客服消息不存在");
    ErrorCode KF_MSG_CURSOR_NOT_EXISTS = new ErrorCode(2_020_013_010, "客服消息偏移量不存在");
    ErrorCode KF_NOTICE_LOG_NOT_EXISTS = new ErrorCode(2_020_013_011, "客服员工通知日志不存在");
    ErrorCode KF_POOL_NOT_EXISTS = new ErrorCode(2_020_013_012, "客服接待池不存在");
    ErrorCode KF_SCENES_NOT_EXISTS = new ErrorCode(2_020_013_013, "客服场景信息不存在");
    ErrorCode KF_SERVICER_NOT_EXISTS = new ErrorCode(2_020_013_014, "客服接待人员不存在");
    ErrorCode KF_USER_STAT_NOT_EXISTS = new ErrorCode(2_020_013_015, "客服员工统计不存在");
    ErrorCode KF_WELCOME_NOT_EXISTS = new ErrorCode(2_020_013_016, "客服欢迎语不存在");
