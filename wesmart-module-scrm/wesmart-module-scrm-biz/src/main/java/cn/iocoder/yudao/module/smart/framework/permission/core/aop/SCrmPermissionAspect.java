//package cn.iocoder.yudao.module.smart.framework.permission.core.aop;
//
...
//    public void doBefore(JoinPoint joinPoint, SCrmPermission crmPermission) {
//        // 1.1 获取相关属性值
...
//        // 1. 如果是超级管理员则直接通过
//        if (SCrmPermissionUtils.isCrmAdmin()) {
//            return;
//        }
