...
import cn.iocoder.yudao.module.smart.service.IWeGroupSopService;
...
import cn.iocoder.yudao.module.smart.dal.dataobject.community.WeGroupSop;
import cn.iocoder.yudao.module.smart.dal.dataobject.community.WeGroupSopChat;
...
import cn.iocoder.yudao.module.smart.dal.dataobject.community.vo.WeGroupSopVo;
        ...
        if (StringUtils.isNotEmpty(chatIdList)) {
            List<WeGroupSopChat> sopChatList = chatIdList
                    ...
                    .map(id ->{
                        ...
                        weGroupSopChat.setCreateBy(String.valueOf(ScrmSecurityUtils.getUserId()));
                        weGroupSopChat.setCreateTime(new Date());
                        weGroupSopChat.setUpdateBy(String.valueOf(ScrmSecurityUtils.getUserId()));
