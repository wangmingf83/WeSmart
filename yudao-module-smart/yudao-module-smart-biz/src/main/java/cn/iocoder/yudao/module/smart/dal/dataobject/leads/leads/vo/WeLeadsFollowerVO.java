...
public class WeLeadsFollowerVO {
     ...
     * 跟进人所属部门
     */
    @Schema(description = "跟进人所属部门")
    private String followUserDeptName;

    /**
     * 跟进状态 0待分配, 1跟进中，2已上门 3已退回
     */
    @Schema(description = "跟进状态 0待分配, 1跟进中，2已上门 3已退回")
     ...
     */
    @Schema(description = "退回方式code 0 成员主动退回 1 过期自动强制回收 2 管理员退回 3 离职退回 4 线索转移")
    private Integer backMode;

    /**
     * 退回方式 0 成员主动退回 1 过期自动强制回收 2 管理员退回 3 离职退回 4 线索转移
     */
    @Schema(description = "退回方式")
