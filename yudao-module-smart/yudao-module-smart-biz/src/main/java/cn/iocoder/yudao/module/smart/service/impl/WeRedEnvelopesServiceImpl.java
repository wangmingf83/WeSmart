...
import cn.iocoder.yudao.module.common.enums.ReEnvelopesStateType;
import cn.iocoder.yudao.module.common.enums.RedEnvelopesReturnStatus;
...
import cn.iocoder.yudao.module.smart.dal.dataobject.envelopes.dto.WeRedEnvelopesParmDto;
import cn.iocoder.yudao.module.smart.dal.dataobject.envelopes.dto.WeRedEnvelopesResultDto;
...
import cn.iocoder.yudao.module.smart.dal.mysql.mapper.WeRedEnvelopesLimitMapper;
import cn.iocoder.yudao.module.smart.dal.mysql.mapper.WeRedEnvelopesMapper;
import cn.iocoder.yudao.module.smart.dal.mysql.mapper.WeRedEnvelopesRecordMapper;

import cn.iocoder.yudao.module.common.utils.*;
...
public class WeRedEnvelopesServiceImpl extends ServiceImpl<WeRedEnvelopesMapper, WeRedEnvelopes> implements IWeRedEnvelopesService {
    ...
    public H5RedEnvelopesDetailDto detailDto(String orderNo, String openid, String chatId) {
        ...
        if(StringUtils.isEmpty(chatId)){//非群成员相关设置
            ...
            int naAcceptNum = Math.toIntExact(weRedEnvelopesRecordMapper.selectCount(new LambdaQueryWrapper<WeRedEnvelopesRecord>()
                    .eq(WeRedEnvelopesRecord::getOrderNo, orderNo)
                    .eq(WeRedEnvelopesRecord::getSource, 2)
                    .eq(WeRedEnvelopesRecord::getChatId, chatId)
                    .eq(WeRedEnvelopesRecord::getSendState, 1)));
            h5RedEnvelopesDetailDto.setNoAcceptNum(naAcceptNum);

            int aAcceptNum = Math.toIntExact(weRedEnvelopesRecordMapper.selectCount(new LambdaQueryWrapper<WeRedEnvelopesRecord>()
                    .eq(WeRedEnvelopesRecord::getOrderNo,orderNo)
                    .eq(WeRedEnvelopesRecord::getSource,2)
                    .eq(WeRedEnvelopesRecord::getChatId,chatId)
                    .eq(WeRedEnvelopesRecord::getSendState,2)));
            h5RedEnvelopesDetailDto.setAcceptNum(aAcceptNum);
        }
