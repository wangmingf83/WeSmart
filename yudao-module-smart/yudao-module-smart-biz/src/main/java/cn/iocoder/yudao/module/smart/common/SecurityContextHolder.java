...
import cn.iocoder.yudao.module.smart.core.text.Convert;
...
public class SecurityContextHolder {
    ...
    public static Long getWeUserId() {
        return Convert.toLong(get(SecurityConstants.Details.WE_USER_ID.getCode()), 0L);
    }

    public static void setWeUserId(String userId) {
        set(SecurityConstants.Details.WE_USER_ID.getCode(), userId);
    }
    ...
    public static Integer getUserType() {
        return Integer.valueOf(get(SecurityConstants.Details.USER_TYPE.getCode()));
    }
...
//    }
    ...
    public static Long getTenantId() {
        return Convert.toLong(get(SecurityConstants.Details.TENANT_ID.getCode()));
    }
}
