...
@Component
@Data
@ConfigurationProperties(prefix = "GuituAi")
public class GuituAiConfig {
    /**
     * 项目名称
     */
    private String name;
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        GuituAiConfig.addressEnabled = addressEnabled;
    }
